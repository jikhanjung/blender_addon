...
def create_gn_tree_4x():
    ...
    # 블렌더 4.x에서는 new_item 대신 new_socket 사용
    ...
    # 블렌더 4.x에서는 new_property 대신 new_socket으로 프로퍼티도 생성
    scale_prop = node_group.interface.new_socket(
        name='Scale Multiplier',
        in_out='INPUT',
        socket_type='NodeSocketFloat'
    )
    # Float 소켓의 기본값과 범위 설정
    ...
    # ColorRamp 노드(4.x)
    # 블렌더 4.x에서는 FunctionNodeColorRamp가 아닌 ShaderNodeValToRGB 사용
